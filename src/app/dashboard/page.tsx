    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/dashboard/activity" className="text-sm font-bold text-primary hover:underline flex items-center gap-1 group">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 overflow-hidden">
        <div className="flex justify-between items-center mb-8">
            ...
            <Link href="/dashboard/classes" className="bg-gray-100 text-[#1A1A2E] text-xs font-black uppercase px-4 py-2 rounded-full hover:bg-gray-200 transition-colors flex items-center gap-2">
